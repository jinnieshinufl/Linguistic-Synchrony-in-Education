...
# specific_filenames = 'f3b69512-0b6a-49fa-bac7-df278420cedb'
# data = df[df['filename'] == specific_filenames]
...
for filename in distinct_filenames:
    ...
    # instructor_processed = [preprocess_text(doc) for doc in instructor_df]
    # student_processed = [preprocess_text(doc) for doc in student_df]
    # all_processed = instructor_processed + student_processed
    ...
    for level in component_levels:
        ...
        # print('Document-document similarity', similarities)
...
# Initialize a dictionary to hold dataframes for each component level
